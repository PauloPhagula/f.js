 ...
 */
var F=function(t){"use strict";var r={},e=r;return r.VERSION="0.1.4",r.DEBUG=!1,r.noConflict=function(){return r=e,this},Object.getOwnPropertyDescriptors=function(t){var r={};for(var e in t)t.hasOwnProperty(e)&&(r[e]=Object.getOwnPropertyDescriptor(t,e));return r},r.compose=Object.assign,r.extend=function(t,r){var e,o=this;return t.hasOwnProperty("constructor")||Object.defineProperty(t,"constructor",{value:function(){o.apply(this,arguments)},writable:!0,configurable:!0,enumerable:!1}),e=t.constructor,Object.assign(e,o,r),e.prototype=Object.create(o.prototype,Object.getOwnPropertyDescriptors(t)),e.prototype.constructor=e,e.__super__=o.prototype,e},r}();
F.dispatcher=function(t){"use strict";var a="ID_",i="ACTION",c=!1,r={},l={},s=1,n=null,e=function(t){if(c)throw new Error("Cannot run "+t+"in the middle of a dispatch.")};return{subscribe:function(t,i,c){e("Dispatcher.subscribe(...)");var r=(this._callbacks||(this._callbacks={}),a+s++);return(this._callbacks[t]||(this._callbacks[t]=[])).push({callback:i,context:c,id:r}),r},unsubscribe:function(t,a){e("Dispatcher.subscribe(...)");var i,c,r,l;if(!(c=this._callbacks[t]))return this;if(!(i=this._callbacks[t]))return this;for(r=0,l=i.length;l>r;r++){var s=i[r];s===a&&i.splice(r)}},publish:function(){var t=Array.prototype.slice.call(arguments,0),a=t.shift();if(a!==i){var c,r,s,n;if((r=this._callbacks)&&(c=this._callbacks[a]))for(s=0,n=c.length;n>s;s++){var e=c[s];e.callback.apply(e.context||null,t)}}else{this._startDispatching(t);try{var h,o,u,f;if(!(o=this._callbacks))return;if(!(h=this._callbacks[i]))return;for(u=0,f=h.length;f>u;u++){var p=h[u];l[p.id]||p.callback.apply(p.context||null,t)}}finally{this._stopDispatching()}}},dispatch:function(t){e("Dispatcher.dispatch(...)"),this.publish(i,t)},waitFor:function(t){e("Dispatcher.waitFor(...)");for(var a=function(t){t.id===s&&(n=t)},c=0;c<t.length;c++){var s=t[c];if(l[s]){if(!r[s])throw new Error("dispatcher.waitFor(...): Circular dependency detected while waiting for "+s)}else{var n=null;if(this._callbacks[i].forEach(a(handler)),!n)throw new Error("dispatcher.waitFor(...):"+s+" does not map to a registered callback.");l[s]=!0,n.callback.apply(n.context||null),r[s]=!0}}},_startDispatching:function(t){var a,s,e,h;if((s=this._callbacks)&&(a=this._callbacks[i])){for(e=0,h=a.length;h>e;e++){var o=a[e];l[o.id]=!1,r[o.id]=!1}n=t,c=!0}},_stopDispatching:function(){n=null,c=!1}}}();
...
F.Store=function(t){"use strict";function i(t,i){var n=this;this._dispatcher=t,this._name=i,this._changed=!1,this._data=[],this._dispatchFlow=function(t){n._changed=!1,n._handleDispatch(t),n._changed&&n.emitChange()},n._dispatchToken=t.subscribe(a,this._dispatchFlow),this.actions={},this.init.apply(this,arguments)}var n="CHANGE",a="ACTION";return F.compose(i.prototype,{init:function(){throw new Error("Store initialization not done. Override this function")},_handleDispatch:function(t){throw new Error("Store payload handling not done. Override this function")},getDispatchToken:function(){return this._dispatchToken},addChangeListener:function(t){this._callbacks||(this._callbacks={});(this._callbacks[n]||(this._callbacks[n]=[])).push({callback:t})},removeChangeListener:function(t){var i,a,e,s;if(!(a=this._callbacks))return this;if(!(i=this._callbacks[n]))return this;for(e=0,s=i.length;s>e;e++){var h=i[e];h===t&&i.splice(e)}},emitChange:function(){var t,i,a,e;if(!(i=this._callbacks))return this;if(!(t=this._callbacks[n]))return this;for(a=0,e=t.length;e>a;a++){var s=t[a];s.callback.apply()}}}),i.extend=F.extend,i}();
