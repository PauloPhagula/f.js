 ...
 */
var F=function(t,r,o){"use strict";var e={},n=e;return e.VERSION="0.1.1",e.DEBUG=!1,e.noConflict=function(){return e=n,this},e.compose=r.extend,e.extend=function(t,o){var e,n=this;return e=t&&r.has(t,"constructor")?t.constructor:function(){return n.apply(this,arguments)},r.extend(e,n,o),e.prototype=r.create(n.prototype,t),e.prototype.constructor=e,e.__super__=n.prototype,e},e}(jQuery,_);
F.dispatcher=function(){"use strict";var t="ID_",a="ACTION",l=!1,c={},i={},r=1,s=null;return{subscribe:function(a,l,c){var i=(this._callbacks||(this._callbacks={}),t+r++);return(this._callbacks[a]||(this._callbacks[a]=[])).push({callback:l,context:c,id:i}),i},unsubscribe:function(t,a){var l,c,i,r;if(!(c=this._callbacks[t]))return this;if(!(l=this._callbacks[t]))return this;for(i=0,r=l.length;r>i;i++){var s=l[i];s===a&&l.splice(i)}},publish:function(){var t=Array.prototype.slice.call(arguments,0),l=t.shift();if(l!==a){var c,r,s,n;if((r=this._callbacks)&&(c=this._callbacks[l]))for(s=0,n=c.length;n>s;s++){var e=c[s];e.callback.apply(e.context||null,t)}}else{this._start(t);try{var h,o,u,f;if(!(o=this._callbacks))return;if(!(h=this._callbacks[a]))return;for(u=0,f=h.length;f>u;u++){var b=h[u];i[b.id]||b.callback.apply(b.context||null,t)}}finally{this._stop()}}},dispatch:function(t){this.publish(a,t)},waitFor:function(t){for(var l=function(t){t.id===s&&(n=t)},r=0;r<t.length;r++){var s=t[r];if(i[s]){if(!c[s])throw new Error("dispatcher.waitFor(...): Circular dependency detected while waiting for "+s)}else{var n=null;if(this._callbacks[a].forEach(l(handler)),!n)throw new Error("dispatcher.waitFor(...):"+s+" does not map to a registered callback.");i[s]=!0,n.callback.apply(n.context||null),c[s]=!0}}},_start:function(t){var r,n,e,h;if((n=this._callbacks)&&(r=this._callbacks[a])){for(e=0,h=r.length;h>e;e++){var o=r[e];i[o.id]=!1,c[o.id]=!1}s=t,l=!0}},_stop:function(){s=null,l=!1}}}();
...
F.Core=function(e,t,n,r){"use strict";function o(){u={},c={},f={},d={},p=!1}function i(e){if(u.debug)throw e;t.publish("error",{exception:e})}function s(e,t){var n,r;for(n in e)r=e[n],"function"==typeof r&&(e[n]=function(e,n){return function(){var r=t+"."+e+"() - ";try{return n.apply(this,arguments)}catch(o){o.methodName=methodName,o.objectName=t,o.name=r+o.name,o.message=r+o.message,i(o)}}}(n,r))}function a(){}var u={debug:!1},c={},f={},d={},p=!1;return F.compose(a.prototype,{init:function(e){u=$.extend({},u,e),this.startAll(document.documentElement),n.start(),t.publish("app init"),p=!0},destroy:function(){this.stopAll(document.documentElement),o(),n.stop()},registerExtension:function(e,t,n,r){if(c.hasOwnProperty(e))return i(new Error("An extension with the given name has already been registered. Ext name: "+e));t=t||[],r=r||{};var o=t;o.push(n);var s=F.injector.resolve(o);s.init(r),c[e]=s,F.injector.register(e,s)},registerStore:function(e,t){d[e]=t},registerModule:function(e,t,n,r,o){return c.hasOwnProperty(e)?i(new Error("Module with given name has already been registered. Mod name: "+e)):void(f[e]={factory:r,extensions:t,stores:n,options:o,instance:null})},start:function(e,t){if(!f.hasOwnProperty(e))return i(new Error("Trying to start non-registered module: "+e));var n=f[e],r=new F.Sandbox(this,e,t);n.instance=new n.factory(r,e,n.options);for(var o={},a={},p=0;p<n.extensions.length;p++){var h=n.extensions[p];if(!c.hasOwnProperty(h))return i(new Error("Module requires an unregistered extensions: "+h));o[h]=c[h]}for(var p=0;p<n.stores.length;p++){var l=n.stores[p];if(!d.hasOwnProperty(l))return i(new Error("Module requires an unregistered store: "+l));a[l]=d[l]}u.debug||s(n.instance,e),n.instance.start(t,o,a)},stop:function(e){var t=f[e];return t&&t.instance?(t.instance.stop(),void(t.instance=null)):i(new Error("Unable to stop module: "+e))},restart:function(e){this.stop(e),this.start(e)},startAll:function(e){for(var t in f)f.hasOwnProperty(t)&&this.start(t);return this},stopAll:function(e){for(var t in f)f.hasOwnProperty(t)&&this.stop(t);return this},dispatcher:t,router:n,getConfig:function(e){return"undefined"==typeof e?u:e in u?u[e]:null},setConfig:function(e){return p?i(new Error("Cannot set configuration after application is initialized")):void(u=$.extend({},u,e))},reportError:i}),a.extend=F.extend,a}(F.injector,F.dispatcher,F.router);
